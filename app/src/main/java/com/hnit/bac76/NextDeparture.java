...
public class NextDeparture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_departure);
    ...
    private void reloadWidgets() {
        readyL = readyR = 0;
        leftSpinner.setAdapter(new ArrayAdapter<String>(this, R.layout.mylist, schedules.lefts));
        rightSpinner.setAdapter(new ArrayAdapter<String>(this, R.layout.mylist, schedules.rights));
